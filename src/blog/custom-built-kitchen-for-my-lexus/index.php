...
<article id="article">
	...
	<section class="article-body">
		...
		<div class="paragraph">
			...
			<img src="water-jug-2.jpg" alt="Refilling my water bottle" >
		</div>
		<div class="paragraph">
			<h2>
		...
		<div class="paragraph">
			...
			<img src="costco.jpg" alt="Costco pizza" >
		</div>
		<div class="paragraph">
			<h2>
		...
		<div class="paragraph">
			...
			<p>
				...
				<ul>
					<li>
						<a href="https://a.co/d/bgM2qhp" target="_blank">UHMW polyethylene tape</a> to allow the entire project to slide out smoothly and quietly
					</li>
					<li>
						<a href="https://a.co/d/4RqTeQ5" target="_blank">Neodymium magnets</a> to catch sliding pieces and coax them into place
					</li>
					<li>
						<a href="https://a.co/d/fkZdBF6" target="_blank">Steel braces</a> to reinforce the foam walls
					</li>
					<li>
						<a href="https://a.co/d/40sze5R" target="_blank">2mm rubber seal strips</a> to close any air gaps around the cooler
					</li>
				</ul>
			</p>
