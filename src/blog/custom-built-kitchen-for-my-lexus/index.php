...
<article id="article">
	<header class="article-heading">
		...
		<p class="article-info">
			By Kristian Windsor on June 21st, 2024
		</p>
	</header>
	<section class="article-body">
		...
		<div class="paragraph">
			...
			<p>
				One primary feature of my car's kitchen is the 3.5-gallon water jug with a faucet, ingeniously designed for convenience and practicality. Wrapped in high-quality insulation, this jug remains cool even during the hottest days, ensuring crisp and refreshing water at all times.
			</p>
			<p>
		...
		<div class="paragraph">
			...
			<p>
				Another key feature of my car's kitchen is the high-performance cooler, meticulously designed to preserve the freshness and quality of your food, even for perishables like milk and raw meat. Encased in up to 5 inches of R-5 insulation foam, this outperforms Yeti coolers and anything else on the market.
			</p>
			<p>
			...
			<p class="caption">
				Opening up the cooler to grab some dinner
			</p>
		</div>
		<div class="paragraph">
			<h2>
			...
			<p>
				Another prominent feature is that this whole thing doubles as a table, providing a convenient surface to cook on, prepare meals, or enjoy your food. 
			</p>
			<img src="table.jpg" alt="Boiling water for instant ramen" >
			<p class="caption">
				Boiling some water for instant ramen in Death Valley
			</p>
		</div>
		<div class="paragraph">
			<h2>
			...
			<p>
				The cooler and the water jug can both be easily removed for restocking and for cleaning. These pieces along with several others are held in place through interlocking friction, gravity, and magnets – much like the way LEGO pieces fit together.
			</p>
		...
		<div class="paragraph">
			...
			<p>
				Beyond its functionality, every detail of this mini kitchen is styled to seamlessly integrate with the aesthetic of this car. The exterior is styled with matching OEM colors and materials, featuring ivory leather wrapping on the face and sides, a wood grain vinyl wrap on the table top, and an OEM cargo mat that's been cut out and mounted to the lid. Even the interior components have been diligently spray-painted black, ensuring a cohesive and premium look.
			</p>
		...
		<div class="paragraph">
			...
			<img src="wip2.jpg" alt="Lexus Kitchen, WIP" >
			<p>
			...
			<img src="wip3.jpg" alt="Lexus Kitchen, WIP" >
		</div>
		<div class="paragraph">
			<h2>
				Conclusion
