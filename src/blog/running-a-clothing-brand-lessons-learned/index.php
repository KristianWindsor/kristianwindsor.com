<?php
	$articleTitle = "Running a Clothing Brand: Lessons Learned";
	$articleDescription = "Spoiler: don't run a clothing a brand.";
	$articleUrl = "running-a-clothing-brand-lessons-learned";
	$imageUrl = "mom-card.jpg";
...
<article id="article">
	<header class="article-heading">
		...
		<p class="article-info">
			By Kristian Windsor on May 3rd, 2018
		</p>
	</header>
